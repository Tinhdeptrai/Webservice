 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://skyplushotelservice.somee.com/WebService.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://skyplushotelservice.somee.com/WebService.asmx?wsdl");
